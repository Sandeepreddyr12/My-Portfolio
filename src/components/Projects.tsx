  ...
  return (
    <div id="projects" className="w-screen mx-auto px-3  md:px-6   mb-16 py-20">
      ...
      <p className="text-secondary font-mono md:ml-10  my-6 w-full lg:w-[80%]">
        ...
        of the free tiers on Heroku, AWS S3 and other services, as well as my extensive use of
        beta/unstable features. However, I&apos;ve taken steps to ensure that
        each project remains accessible by providing GitHub repository links or
        pre-recorded videos. Almost always, my personal projects are unique and
        offer a very good learning curve. Decent-Bet is my current best
        project.{' '}
      </p>
